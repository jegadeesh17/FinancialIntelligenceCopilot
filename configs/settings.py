"""Central configuration loaded from environment variables using Pydantic Settings."""
...
class Settings(BaseSettings):
    ...
    app_name: str = "FinancialIntelligenceCopilot"
    ...
    # Observability & Gateway Settings (Portkey / OpenTelemetry)
    portkey_api_key: str = Field(default="", description="Optional Portkey AI Gateway API Key")
    portkey_gateway_url: str = Field(default="https://api.portkey.ai/v1", description="Portkey Gateway base URL")
    ...
    enable_hybrid_search: bool = Field(default=True, description="Enable BM25 + dense hybrid search by default")
    hybrid_alpha: float = Field(default=0.5, ge=0.0, le=1.0, description="RRF balance (0.5 = equal dense and sparse)")
